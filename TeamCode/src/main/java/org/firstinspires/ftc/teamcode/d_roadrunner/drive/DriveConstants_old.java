...
public class DriveConstants_old {
	...
	public static       PIDFCoefficients MOTOR_VELO_PID    = new PIDFCoefficients(13, 0, 0.2, getMotorVelocityF(
	...
	public static double GEAR_RATIO   = 0.6667; // output (wheel) speed / input (motor) speed
	...
	public static double MAX_ANG_VEL   = Math.toRadians(262.0963516625167);
