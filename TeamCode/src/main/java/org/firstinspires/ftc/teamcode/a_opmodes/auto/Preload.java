...
@Autonomous(name = "Preload", group = ".Score", preselectTeleOp = "MainTeleOp")
public class Preload extends CommandOpMode {
	@Override
	public void initialize() {
		...
		TrajectorySequence auto2 = bot.drive.trajectorySequenceBuilder(auto1.end())
		                                    .setReversed(true)
		                                    .splineTo(new Vector2d(-35.00, -35.00), Math.toRadians(-90.00))
		                                    .build();
