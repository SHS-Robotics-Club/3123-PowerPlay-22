...
@Config
public class Lift3SubsystemBB extends SubsystemBase {
    MotorGroup lift;
    MotorEx liftLeft, liftRight;
    int targetPosition = 0;
    double positionTolerance = 5;

    public static double kP=0.05, kI=0.0, kD=0.0, kS=0.0, kG=0.0, kV=0.0, kA=0.0;
    ...
    public Lift3SubsystemBB(MotorEx liftLeft, MotorEx liftRight) {
