...
@Autonomous(name = "P: BLUE_RIGHT", group = "Parking", preselectTeleOp = "CommandTeleOp")
public class ParkBR extends CommandOpMode {
	@Override
	public void initialize() {
		...
		AutoConfig auto = new AutoConfig(hardwareMap, ParkCommand.StartingZone.BLUE_RIGHT);
